...
public class Struct_sword_216 {
    ...
    public Struct_sword_216(int id,String name,int icon,int pic,int pin,String attr,String starattr,int power,int starpower,String item,int max,int star,int starid,int tptx) {
        this.id = id;
        this.name = name;
        this.icon = icon;
        this.pic = pic;
