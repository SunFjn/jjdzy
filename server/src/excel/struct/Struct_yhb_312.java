...
public class Struct_yhb_312 {
    ...
    public Struct_yhb_312(int id,String name,int sx,String xh1,String jl,String jl2,String xh2,String jl3,String jl4,String xh3,String jl5,String jl6) {
        this.id = id;
        this.name = name;
        this.sx = sx;
