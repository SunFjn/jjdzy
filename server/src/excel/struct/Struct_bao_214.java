...
public class Struct_bao_214 {
    ...
    public Struct_bao_214(int id,String name,int icon,int pic,int pin,String attr,String starattr,int power,int starpower,int skill,String item,int max,int star) {
        this.id = id;
        this.name = name;
        this.icon = icon;
        this.pic = pic;
