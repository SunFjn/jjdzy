    ...
    protected void decode(ChannelHandlerContext ctx, ByteBuf in, List<Object> out) throws SSLException {
        ...
        if (packetLength == 0) {
            ...
            if (packetLength == -1) {
            	...
            	logger.info("not an SSL/TLS record,"+ctx.channel());
            	ctx.pipeline().remove(WebSocketSSLServer.sslHandlerName);
