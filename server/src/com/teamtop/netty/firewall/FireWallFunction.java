 ...
 */
@Sharable
public class FireWallFunction{
	 private static Logger logger = LoggerFactory.getLogger(FireWallFunction.class);
	/**
	 * @param connection
	 * @return
	 */
	...
	public static void channelRead(ChannelHandlerContext ctx, int bytes) throws Exception {
