...
import com.teamtop.system.openDaysSystem.saintMonsterTreasure.SaintMonsterTreasureConst;
import com.teamtop.system.openDaysSystem.saintMonsterTreasure.SaintMonsterTreasureSysCache;
...
public class SaintMonsterTreasureIO {

	private static SaintMonsterTreasureIO ins;

	private SaintMonsterTreasureIO() {
		// TODO Auto-generated constructor stub
	}

	public static synchronized SaintMonsterTreasureIO getIns() {
		if (ins == null) {
			ins = new SaintMonsterTreasureIO();
		}
		return ins;
	}
	...
	public void updateRank(Channel channel, CrossData crossData) {
		try {
			...
			LogTool.error(e, SaintMonsterTreasureIO.class, "SaintMonsterTreasureIO updateRank");
		}
	}
	...
	public void updateRankHandle(Channel channel, CrossData crossData) {
		try {
			...
			LogTool.error(e, SaintMonsterTreasureIO.class, "SaintMonsterTreasureIO updateRankHandle");
		}
	}
	...
	public void askUpdate(Channel channel, CrossData crossData) {
		try {
			...
			LogTool.error(e, SaintMonsterTreasureIO.class, "SaintMonsterTreasureIO askUpdate");
		}
	}
	...
	public void sendReward(Channel channel, CrossData crossData) {
		try {
			...
			LogTool.error(e, SaintMonsterTreasureIO.class, "SaintMonsterTreasureIO sendReward");
		}
	}
