...
public class WarOrderSysEvent extends AbsSystemEvent {
	...
	public void login(Hero hero) {
		if (OpenDaysSystemFunction.getIns().isSystemActOpen(hero, SystemIdConst.WARORDER1)) {
			...
			RedPointFunction.getIns().addLoginRedPoint(hero, SystemIdConst.WARORDER1, RedPointConst.RED_1,
					RedPointConst.HAS_RED);
		}
		if (OpenDaysSystemFunction.getIns().isSystemActOpen(hero, SystemIdConst.WARORDER2)) {
			WarOrderNewFunction.getIns().checkALLTask(hero);
			RedPointFunction.getIns().addLoginRedPoint(hero, SystemIdConst.WARORDER2, RedPointConst.RED_1,
					RedPointConst.HAS_RED);
		}
	}
