...
/**
 * WishingTreeActCG.java
 * 许愿树
 */
public class WishingTreeActCG{

	private static WishingTreeActCG ins = null;

	public static WishingTreeActCG getIns(){
		if(ins == null){
			ins = new WishingTreeActCG();
		}
		return ins;
	}
