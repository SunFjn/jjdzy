...
public class ShaoZhuQiYuanRankActSysCache extends AbsServerEvent {
	...
	/** 排名奖励 */
	private static TreeSet<ShaoZhuQiYuanRankActModel> rankTreeSet = new TreeSet<>();
	/** 跨期缓存 */
	...
	public static void setRankObjArray(Object[] rankObjArray) {
		ShaoZhuQiYuanRankActSysCache.rankObjArray = rankObjArray;
	}

	public static void setSecordThirdObjArray(Object[] secordThirdObjArray) {
		ShaoZhuQiYuanRankActSysCache.secordThirdObjArray = secordThirdObjArray;
	}
	...
	public static void setFirstBodyId(int firstBodyId) {
		ShaoZhuQiYuanRankActSysCache.firstBodyId = firstBodyId;
	}
	...
	public static TreeSet<ShaoZhuQiYuanRankActModel> getRankTreeSet() {
		return rankTreeSet;
	}

	public static void setRankTreeSet(TreeSet<ShaoZhuQiYuanRankActModel> rankTreeSet) {
		ShaoZhuQiYuanRankActSysCache.rankTreeSet = rankTreeSet;
	}
	...
	public void initExcel() throws RunServerException {
		...
		for (Struct_huodong_009 struct_huodong_009 : sortList2) {
			if (struct_huodong_009.getId() == ActivitySysId.SHAOZHU_QIYUANRANK_ACT) {
	...
	public void startServer() throws RunServerException {
		...
		String content = "";
		try {
			content = GlobalCache.getGlobalData(GlobalConst.SHAOZHU_QIYUANRANK_ACT_CROSS_PERIOD_CACHE).getContent();
	...
	public void shutdownServer() {
		...
		String content = "";
		try {
			GlobalData globalData = GlobalCache.getGlobalData(GlobalConst.SHAOZHU_QIYUANRANK_ACT_CROSS_PERIOD_CACHE);
