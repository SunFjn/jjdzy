package com.teamtop.system.activity.ativitys.oneRechargeBack.model;
...
public class OneRechargeBack extends ActivityData {
	/**
	...
	public OneRechargeBack(long id, int index, int actId, int periods) {
		// TODO Auto-generated constructor stub
		super(id, index, actId, periods);
	}


	public OneRechargeBack() {
		super();
	}
