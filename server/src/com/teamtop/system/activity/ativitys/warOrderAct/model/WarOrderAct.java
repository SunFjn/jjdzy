package com.teamtop.system.activity.ativitys.warOrderAct.model;

import java.util.Map;

import com.teamtop.system.activity.model.ActivityData;

public class WarOrderAct extends ActivityData {
	...
	public WarOrderAct(long hid, int indexId, int actId, int periods) {
