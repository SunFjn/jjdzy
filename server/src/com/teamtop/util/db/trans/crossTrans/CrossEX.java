...
import com.teamtop.util.db.trans.objbyte2.test.T1;
import com.teamtop.util.db.trans.objbyte2.test.T2;

public class CrossEX {
	public static void main(String[] args) {
		...
		byte[] write = CrossTrans.write(t1, T1.class);
		T1 read = CrossTrans.read(write, T1.class);
