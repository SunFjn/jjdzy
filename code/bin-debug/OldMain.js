...
var OldMain = (function (_super) {
    ...
    OldMain.prototype.onAddToStage = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        if (!self.hasWxSdk) return [3 /*break*/, 5];
    ...
    OldMain.prototype.getphpData = function () {
        return __awaiter(this, void 0, void 0, function () {
            var self;
            return __generator(this, function (_a) {
                self = this;
    ...
    OldMain.prototype.initialize = function () {
        App.init();
    ...
    OldMain.prototype.enterGame = function () {
        return __awaiter(this, void 0, void 0, function () {
            var self, _a, _b, _c, _d, _e, _f;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 5:
                        ...
                        _b = self;
                        return [4 /*yield*/, self.loadGameCfg("config1_json")];
                    case 6:
                        _b.cfg2 = _g.sent();
                        GameLoadingView.getInst().showPro(0.7, "加载游戏配置2");
                        _c = self;
                        return [4 /*yield*/, self.loadGameCfg("config2_json")];
                    case 7:
                        _c.cfg3 = _g.sent();
                        GameLoadingView.getInst().showPro(0.75, "加载游戏配置2");
                        _d = self;
                        return [4 /*yield*/, self.loadGameCfg("config3_json")];
                    case 8:
                        _d.cfg4 = _g.sent();
                        GameLoadingView.getInst().showPro(0.8, "加载游戏配置3");
                        _e = self;
                        return [4 /*yield*/, self.loadGameCfg("config4_json")];
                    case 9:
                        _e.cfg5 = _g.sent();
                        GameLoadingView.getInst().showPro(0.85, "加载游戏配置3");
                        _f = self;
                        return [4 /*yield*/, self.loadGameCfg("config5_json")];
                    case 10:
                        _f.cfg6 = _g.sent();
                    ...
                    case 12:
                        _g.sent();
                        if (!GGlobal.main.isNewRole) return [3 /*break*/, 17];
    ...
    OldMain.prototype.initGMEntrance = function () {
        ...
        _gmSpr.addChild(spr);
        spr.addEventListener(egret.TouchEvent.TOUCH_BEGIN, function () { GGlobal.layerMgr.open(UIConst.GM); }, this);
        ...
        spr.y = 80;
        _gmSpr.addChild(spr);
        spr.addEventListener(egret.TouchEvent.TOUCH_BEGIN, function () { _gmSpr.parent.removeChild(_gmSpr); }, this);
        spr.touchEnabled = true;
        var gmTxt = new egret.TextField();
        gmTxt.text = "关闭";
        gmTxt.x = (50 - gmTxt.textWidth) / 2;
    ...
    OldMain.prototype.connectServer = function (ip, port) {
        return __awaiter(this, void 0, void 0, function () {
            var self, socketMgr;
            return __generator(this, function (_a) {
                self = this;
    ...
    OldMain.prototype.loadCommonResource = function () {
        return __awaiter(this, void 0, void 0, function () {
            var self;
            return __generator(this, function (_a) {
                self = this;
    ...
    OldMain.prototype.loadGameCfg = function (url) {
        return __awaiter(this, void 0, void 0, function () {
            var self;
            return __generator(this, function (_a) {
                self = this;
    ...
    OldMain.prototype.parseConfig = function () {
        return __awaiter(this, void 0, void 0, function () {
            var self;
            return __generator(this, function (_a) {
                self = this;
    ...
    OldMain.prototype.concactCFG = function (data) {
        var ret = {};
    ...
    OldMain.prototype.prepareRoleInfo = function () {
        var self = this;
    ...
    /**加载角色资源 */
    OldMain.prototype.loadRoleResource = function () {
        return __awaiter(this, void 0, void 0, function () {
            var self;
            return __generator(this, function (_a) {
                self = this;
    ...
    OldMain.prototype.checkCreateRole = function () {
        return __awaiter(this, void 0, void 0, function () {
            var self;
            return __generator(this, function (_a) {
                self = this;
    ...
    OldMain.prototype.playCartong = function () {
        return __awaiter(this, void 0, void 0, function () {
            var self;
            return __generator(this, function (_a) {
                self = this;
    ...
    OldMain.prototype.hideLoading = function () {
        GameLoadingView.getInst().clearMemTaken();
        GameLoginView1.getInst().uidispose();
    };
    OldMain.prototype.setloadVis = function (v) {
        if (!v)
            GameLoadingView.getInst().hide();
    };
    OldMain.prototype.hideLoadBg = function () {
        window && window.hideServerBg(); //不知为什么比游戏大。创角直接移除吧
    };
    OldMain.prototype.showStoreAni = function () {
