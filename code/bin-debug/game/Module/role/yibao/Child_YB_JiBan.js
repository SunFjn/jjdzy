...
var Child_YB_JiBan = (function (_super) {
    __extends(Child_YB_JiBan, _super);
    function Child_YB_JiBan() {
    ...
    Child_YB_JiBan.createInstance = function () {
        return (fairygui.UIPackage.createObject("role", "Child_BaoWu_JiBan"));
    };
    Child_YB_JiBan.prototype.constructFromXML = function (xml) {
    ...
    Child_YB_JiBan.prototype.onOpen = function () {
        var sf = this;
        sf.eventFunction(1);
        GGlobal.control.listen(Enum_MsgType.BY_SYS_JI_BAN, sf.jiBanUp, sf);
        sf.update();
    };
    Child_YB_JiBan.prototype.onClose = function () {
        var sf = this;
    ...
    Child_YB_JiBan.prototype.jiBanUp = function (arr) {
        var sf = this;
        var sys = arr[0];
        var index = arr[1];
        var sid = arr[2];
    ...
    Child_YB_JiBan.prototype.update = function () {
        var sf = this;
        sf._jiBanArr = Model_BySys.getJiBan(Model_BySys.JIB_YIBAO);
        sf.list.numItems = sf._jiBanArr.length;
    ...
    Child_YB_JiBan.prototype.upPower = function () {
        //套装战力
        var sf = this;
        var power = 0;
        if (sf._jiBanArr) {
            for (var i = 0; i < sf._jiBanArr.length; i++) {
                ...
                var suit = Config.ybsuit_217[ids];
                if (suit) {
    ...
    Child_YB_JiBan.prototype.renderHander = function (index, obj) {
        var sf = this;
        var gird = obj;
    ...
    Child_YB_JiBan.prototype.renderGrid = function (index, obj) {
        var sf = this;
        var v = obj;
        v.setSuitVo(sf._conditionArr[index]);
    };
    Child_YB_JiBan.prototype.onClickList = function (e) {
        var sf = this;
        var selectItem = e.itemObject;
        sf.selectdUpdate(selectItem.data);
    };
    Child_YB_JiBan.prototype.selectdUpdate = function (suitId) {
        var sf = this;
        if (suitId == null) {
            return;
        }
    ...
    Child_YB_JiBan.prototype.onClickActivity = function () {
        var sf = this;
        if (!sf._hasCondition) {
    ...
    Child_YB_JiBan.prototype.pageHandler = function (event) {
        var sf = this;
    ...
    Child_YB_JiBan.prototype.onExplain = function (e) {
        GGlobal.layerMgr.open(UIConst.WFLAB_PANEL);
        e.stopPropagation();
        e.stopImmediatePropagation();
    };
    Child_YB_JiBan.prototype.jcTxt = function (jc, color) {
        var sf = this;
        if (color)
    ...
    Child_YB_JiBan.URL = "ui://3tzqotadby8m38";
    return Child_YB_JiBan;
}(fairygui.GComponent));
__reflect(Child_YB_JiBan.prototype, "Child_YB_JiBan");
