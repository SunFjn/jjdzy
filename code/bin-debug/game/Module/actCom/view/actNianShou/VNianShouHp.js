...
var VNianShouHp = (function (_super) {
    __extends(VNianShouHp, _super);
    function VNianShouHp() {
    ...
    VNianShouHp.createInstance = function () {
        return (fairygui.UIPackage.createObject("actComNianShou", "VNianShouHp"));
    };
    VNianShouHp.create = function () {
        var pool = VNianShouHp.POOL;
        if (pool.length) {
            return pool.shift();
        }
        return new VNianShouHp();
    };
    VNianShouHp.prototype.init = function (x, y, dmg, iscrit, isHit, isLianJi, isShield) {
    ...
    VNianShouHp.prototype.onAdd = function (pa) {
        var self = this;
        self.scaleX = self.scaleY = 1;
        pa.addChild(self);
    };
    VNianShouHp.prototype.onRemove = function () {
        egret.Tween.removeTweens(this);
        this.parent.removeChild(this);
        VNianShouHp.POOL.push(this);
    };
    VNianShouHp.prototype.onComp = function () {
        this.onRemove();
    };
    VNianShouHp.URL = "ui://ht2966i4plkme";
    VNianShouHp.POOL = [];
    return VNianShouHp;
}(fairygui.GComponent));
__reflect(VNianShouHp.prototype, "VNianShouHp");
