...
var View_ActCom_CzZPShow = (function (_super) {
    __extends(View_ActCom_CzZPShow, _super);
    function View_ActCom_CzZPShow() {
        var _this = _super.call(this) || this;
        _this.times = 10;
        _this.loadRes("bossTiShi", "bossTiShi_atlas0");
        return _this;
    }
    View_ActCom_CzZPShow.prototype.childrenCreated = function () {
    ...
    View_ActCom_CzZPShow.prototype.onShown = function () {
        var cfg = Config.czzpreward_281[this._args];
    ...
    View_ActCom_CzZPShow.prototype.onHide = function () {
        this.list.numItems = 0;
        Timer.instance.remove(this.timeHandler, this);
    };
    View_ActCom_CzZPShow.prototype.OnSure = function () {
        this.doHideAnimation();
    };
    View_ActCom_CzZPShow.prototype.OnContinue = function () {
        this.doHideAnimation();
        GGlobal.model_actCom.CG_CHONG_ZHI_ZP_TURN();
    };
    View_ActCom_CzZPShow.prototype.renderHandler = function (index, obj) {
        var grid = obj;
        var v = this.rewardArr[index];
        v.item.extra = v.isBig ? 5 : 0;
        grid.vo = v.item;
    };
    View_ActCom_CzZPShow.prototype.timeHandler = function () {
        this.times--;
    ...
    return View_ActCom_CzZPShow;
}(UIModalPanel));
__reflect(View_ActCom_CzZPShow.prototype, "View_ActCom_CzZPShow");
