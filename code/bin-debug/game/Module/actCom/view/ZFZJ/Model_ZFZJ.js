...
var Model_ZFZJ = (function (_super) {
    __extends(Model_ZFZJ, _super);
    function Model_ZFZJ() {
    ...
    //协议处理
    Model_ZFZJ.prototype.listenServ = function (mgr) {
        var self = this;
        this.socket = mgr;
        //注册GC方法
    ...
    Model_ZFZJ.prototype.GC_HeFuZhangFeiBoss_openUi_9640 = function (self, data) {
        ...
        if (self.state == 2) {
            var cfg = Config.hfkhzfzj_286[self.bossLv];
            if (cfg.next > 0) {
                self.state = 0;
        ...
        for (var i = 0; i < len1; i++) {
            var wineID = data.readInt();
            var wineNum = data.readInt();
    ...
    Model_ZFZJ.prototype.CG_HeFuZhangFeiBoss_addjiu_9641 = function (arg1) {
        var bates = this.getBytes();
        bates.writeByte(arg1);
        this.sendSocket(9641, bates);
    };
    /**9642 B-B-I-B-L-L GC 敬酒返回 B:敬酒结果0成功 1失败B:敬酒类型I:张飞醉意B:boss状态I:元宝敬酒次数*/
    Model_ZFZJ.prototype.GC_HeFuZhangFeiBoss_addjiu_9642 = function (self, data) {
    ...
    Model_ZFZJ.prototype.GC_HeFuZhangFeiBoss_bossSate_9644 = function (self, data) {
    ...
    /**9645  CG 进入张飞战斗 */
    Model_ZFZJ.prototype.CG_HeFuZhangFeiBoss_join_9645 = function () {
        var bates = this.getBytes();
        this.sendSocket(9645, bates);
    };
    /**9646 B-B GC 进入返回 B:成功 1失败 2活动还没开始 3活动已经结束 4惩罚30s时间内5在副本内restB:自动复活状态 1开启自动复活 0关闭自动state*/
    Model_ZFZJ.prototype.GC_HeFuZhangFeiBoss_joinrest_9646 = function (self, data) {
    ...
    /**9647  CG退出 */
    Model_ZFZJ.prototype.CG_HeFuZhangFeiBoss_quit_9647 = function () {
        var bates = this.getBytes();
        this.sendSocket(9647, bates);
    };
    /**9648 B GC 退出返回 B:离开 B:0离开成功 1失败rest*/
    Model_ZFZJ.prototype.GC_HeFuZhangFeiBoss_quit_9648 = function (self, data) {
    ...
    Model_ZFZJ.prototype.GC_HeFuZhangFeiBoss_noticeDieLive_9650 = function (self, data) {
        var temp = [];
        var hasMine = false;
    ...
    Model_ZFZJ.prototype.GC_HeFuZhangFeiBoss_bossBoolCharge_9652 = function (self, data) {
    ...
    /**9653  CG 通知后端 我本人死亡了 */
    Model_ZFZJ.prototype.CG_HeFuZhangFeiBoss_cgherodie_9653 = function () {
        var bates = this.getBytes();
        this.sendSocket(9653, bates);
    };
    /**9655 B CG 买活 B:0买活 1申请复活type*/
    Model_ZFZJ.prototype.CG_HeFuZhangFeiBoss_buyLive_9655 = function (arg1) {
        var bates = this.getBytes();
        bates.writeByte(arg1);
        this.sendSocket(9655, bates);
    };
    /**9656 B GC 买活返回 B:0成功 1失败 rest*/
    Model_ZFZJ.prototype.GC_HeFuZhangFeiBoss_buyLive_9656 = function (self, data) {
        var ret = data.readByte();
        if (ret == 0)
            GGlobal.control.notify(Enum_MsgType.ZFZJ_ROLE_LIFE);
    };
    /**9657 B CG 自动复活状态 B:1开启自动复活 0关闭自动state*/
    Model_ZFZJ.prototype.CG_HeFuZhangFeiBoss_isaotufuhuo_9657 = function (arg1) {
        var bates = this.getBytes();
        bates.writeByte(arg1);
        this.sendSocket(9657, bates);
    };
    /**9658 B GC 自动复活状态 B:1开启自动复活 0关闭自动state*/
    Model_ZFZJ.prototype.GC_HeFuZhangFeiBoss_isaotufuhuo_9658 = function (self, data) {
        var type = data.readByte();
        GGlobal.control.notify("revieauto", type);
    };
    /**9660 B GC 自动复活结果 B:0成功 1失败rest*/
    Model_ZFZJ.prototype.GC_HeFuZhangFeiBoss_autorest_9660 = function (self, data) {
        var type = data.readByte();
        if (type == 0) {
    ...
    Model_ZFZJ.prototype.GC_HeFuZhangFeiBoss_bossdie_9662 = function (self, data) {
        self.curHp = 0;
        GGlobal.control.notify(Enum_MsgType.ZFZJ_BOSS_DEAD);
    };
    /**9663  CG 打开敬酒排行榜 */
    Model_ZFZJ.prototype.CG_HeFuZhangFeiBoss_openRank_9663 = function () {
        var bates = this.getBytes();
        this.sendSocket(9663, bates);
    };
    /**9664 [B-L-U-I] GC 醉意排行榜 [B:名次L:玩家idU:玩家名字I:玩家醉意值]rankinfos- S:我的排名I:我的敬酒*/
    Model_ZFZJ.prototype.GC_HeFuZhangFeiBoss_openrank_9664 = function (self, data) {
        self.wineRankData = {};
        var len = data.readShort();
        for (var i = 0; i < len; i++) {
    ...
    Model_ZFZJ.prototype.CG_HeFuZhangFeiBoss_getBossReward_9665 = function (arg1) {
        var bates = this.getBytes();
        bates.writeInt(arg1);
        this.sendSocket(9665, bates);
    };
    /**9666 I-B GC boss被击杀奖励情况 I:boss序号indexB:奖励情况0 1 2state*/
    Model_ZFZJ.prototype.GC_HeFuZhangFeiBoss_rewardCharge_9666 = function (self, data) {
        var bossLv = data.readInt();
        var state = data.readByte();
...
__reflect(Model_ZFZJ.prototype, "Model_ZFZJ");
