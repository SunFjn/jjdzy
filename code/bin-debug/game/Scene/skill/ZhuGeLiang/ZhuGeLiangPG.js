...
var ZhuGeLiangPG = (function (_super) {
    __extends(ZhuGeLiangPG, _super);
    function ZhuGeLiangPG() {
    ...
    ZhuGeLiangPG.create = function (role, skill) {
        var ret = new ZhuGeLiangPG();
        ret.role = role;
        ret.skill = skill;
        return ret;
    };
    ZhuGeLiangPG.prototype.update = function (ctx) {
    ...
    ZhuGeLiangPG.prototype.onAdd = function () {
        this.effid = null;
    ...
    ZhuGeLiangPG.prototype.onRemove = function () {
    ...
    ZhuGeLiangPG.prototype.dealHurt = function () {
...
__reflect(ZhuGeLiangPG.prototype, "ZhuGeLiangPG");
