...
class DateUtil2 {
    ...
    public static formatDate(d: Date, formatType: string = "yyyy/mm/dd hh:uu:ss"): string {
        ...
        if (formatType.indexOf("yyyy") != -1) {
            ...
            var ty: string = year < 10 ? "0" + year : "" + year;
     ...
     */
    public static formatTime(time: number, formatType: string = "yyyy/mm/dd hh:uu:ss"): string {
        var d: Date = new Date();
        d.setTime(time);
