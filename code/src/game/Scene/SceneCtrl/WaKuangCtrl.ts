class WaKuangCtrl extends SceneCtrl {
	public constructor() {
		super();
	}
	private static _instance: WaKuangCtrl;
	public static get instance(): WaKuangCtrl {
		if (!WaKuangCtrl._instance) WaKuangCtrl._instance = new WaKuangCtrl();
