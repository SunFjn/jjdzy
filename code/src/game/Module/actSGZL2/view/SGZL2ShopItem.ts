 ...
 */
class SGZL2ShopItem extends fairygui.GComponent {
	...
	public static URL:string = "ui://ggwi8wepqhocg";

	public static createInstance():SGZL2ShopItem {
		return <SGZL2ShopItem><any>(fairygui.UIPackage.createObject("actComSgzl2","SGZL2ShopItem"));
	}

	private _curData: VoSGZL2Shop;
	...
	//=========================================== API ==========================================
	public setData(pData: VoSGZL2Shop) {
		this._curData = pData;
		if (pData) {
