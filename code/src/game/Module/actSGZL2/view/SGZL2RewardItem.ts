 ...
 */
class SGZL2RewardItem extends fairygui.GComponent {
	...
	public static URL: string = "ui://ggwi8wepqhoci";

	private _curData: VoSGZL2Reward;

	public static createInstance(): SGZL2RewardItem {
		return <SGZL2RewardItem><any>(fairygui.UIPackage.createObject("actComSgzl2", "SGZL2RewardItem"));
	}
	...
	//=========================================== API ==========================================
	public setData(pData: VoSGZL2Reward) {
		this._curData = pData;
		if (pData) {
