 ...
 * 连冲豪礼大奖item
*/
class WSZWListGrid extends fairygui.GComponent{
	public grid: ViewGrid;
	public rewardBt0: fairygui.GButton;
	public rewardImg0: fairygui.GImage;
	public rewardGroup0: fairygui.GGroup;
	public static URL: string = "ui://niyo89mic4543";

	public static createInstance(): AuthenListGrid {
		return <AuthenListGrid><any>(fairygui.UIPackage.createObject("WSZWActLCHL", "WSZWListGrid"));
	}
