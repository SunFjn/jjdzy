class View_BossSceneHead extends fairygui.GComponent {
	...
	public static URL: string = "ui://jvxpx9emkw747m";

	private static _instance: View_BossSceneHead;
	public static createInstance(): View_BossSceneHead {
		if (!View_BossSceneHead._instance) View_BossSceneHead._instance = <View_BossSceneHead><any>(fairygui.UIPackage.createObject("common", "View_BossSceneHead"));
	...
	public static show(id: number, isCombo: boolean, mhp?: number, headkey: number = 0, yy: number = 280, namestr: string = null, rewardVo: IGridImpl = null, passStr: string = null) {
		let view = View_BossSceneHead.createInstance();
