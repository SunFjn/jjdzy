...
class ViewWarOrderBuyCt extends UIModalPanel {
	...
	static pkg = "warOrder";
	//>>>>end
	public static URL: string = "ui://5xptxudgml15t";

	public static createInstance(): ViewWarOrderBuyCt {
		return <ViewWarOrderBuyCt>(fairygui.UIPackage.createObject("warOrder", "ViewWarOrderBuyCt"));
	}
