 ...
 * 少主祈愿大奖item
*/
class QiYuanListGrid extends fairygui.GComponent{
	public grid: ViewGrid;
	public rewardBt0: fairygui.GButton;
	public rewardImg0: fairygui.GImage;
	public rewardGroup0: fairygui.GGroup;
	public static URL: string = "ui://w5ll6n5jfoqs1w";

	public static createInstance(): AuthenListGrid {
		return <AuthenListGrid><any>(fairygui.UIPackage.createObject("shaozhuAct", "QiYuanListGrid"));
	}
