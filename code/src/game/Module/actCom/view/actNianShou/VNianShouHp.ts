class VNianShouHp extends fairygui.GComponent {

	public static URL:string = "ui://ht2966i4plkme";

	public static createInstance():VNianShouHp {
		return <VNianShouHp><any>(fairygui.UIPackage.createObject("actComNianShou","VNianShouHp"));
	}

	public static POOL = [];
	public static create(): VNianShouHp {
