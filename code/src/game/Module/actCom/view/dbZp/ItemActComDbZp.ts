class ItemActComDbZp extends fairygui.GComponent {
	...
	public static URL:string = "ui://eh3eod8qve5s1";

	public static createInstance():ItemActComDbZp {
		return <ItemActComDbZp><any>(fairygui.UIPackage.createObject("actComDBZP","ItemActComDbZp"));
	}
	...
	public setdata(data) {
		let s = this;
		let cfg = Config.dbfl_281[data.id];
		s._idx = data.id;
