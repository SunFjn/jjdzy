class ItemXiLianRank1 extends fairygui.GComponent{
	...
	public static URL = "ui://d5y9ngt6cl031p";

	public static createInstance(): ItemXiLianRank1 {
		return <ItemXiLianRank1><any>(fairygui.UIPackage.createObject("actHolyBeast", "ItemXiLianRank1"));
	}
