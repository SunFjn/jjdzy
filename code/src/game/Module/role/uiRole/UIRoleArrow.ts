class UIRoleArrow extends DepSprite {
	...
	public static LMDROP(arrow: UIRoleArrow, ctx) {
	...
	public static ZY3FUNC(arrow: UIRoleArrow, ctx) {
		arrow.lifeTime += ctx.dt;
	...
	public static LIFEONLY(arrow: UIRoleArrow, ctx) {
		arrow.lifeTime += ctx.dt;
	...
	public static FORWARD(arrow: UIRoleArrow, ctx) {
		arrow.lifeTime += ctx.dt;
		if (arrow.lifeTime >= arrow.dieTime) {
			ctx.d = 1;
		} else {
	...
	public static HZ1FUNC(arrow: UIRoleArrow, ctx) {
		arrow.lifeTime += ctx.dt;
		if (arrow.lifeTime >= arrow.effInterv) {
			ctx.d = 1;
		} else {
	...
	public static ZGL2FUNC(arrow: UIRoleArrow, ctx) {
		arrow.lifeTime += ctx.dt;
		if (arrow.lifeTime >= arrow.effInterv) {
			ctx.d = 1;
		} else {
	...
	public static ZGLTHUNDERFUNC2(arrow: UIRoleArrow, ctx) {
		arrow.lifeTime += ctx.dt;
		if (arrow.lifeTime >= arrow.dieTime) {
			ctx.d = 1;
		} else {
	...
	public static CLBOSSFUNC(arrow: UIRoleArrow, ctx) {
		arrow.lifeTime += ctx.dt;
		if (arrow.lifeTime >= arrow.dieTime) {
			ctx.d = 1;
		} else {
	...
	public static CLBOSSFUNC1(arrow: UIRoleArrow, ctx) {
		arrow.lifeTime += ctx.dt;
		if (arrow.lifeTime >= arrow.dieTime) {
			ctx.d = 1;
		} else {
