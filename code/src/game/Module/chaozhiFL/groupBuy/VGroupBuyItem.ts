class VGroupBuyItem extends fairygui.GComponent {
	...
	public static createInstance(): VGroupBuyItem {
		return <VGroupBuyItem><any>(fairygui.UIPackage.createObject("chaozhifanli", "VGroupBuyItem"));
	}
