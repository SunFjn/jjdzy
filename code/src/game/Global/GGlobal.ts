class GGlobal {
	...
	public static commonpkg: fairygui.UIPackage;
	public static numpkg: fairygui.UIPackage;
	public static loginArg: any = {};
	public static resHead: string = "http://192.168.22.18:8090/";
	// public static resHead: string = "./";
	public static stage: egret.Stage;
	public static main: Main;
	public static sdk: HLSDK;
	public static zone;
	public static zoneName;
	public static ip;
	public static port;
	public static serverVer = '';
	public static clientversion = '';
	public static mainType = 0;

	public static isActivation = true;
	public static isNetWorking = true;
	public static frameScale = 2;
	public static aniCfg: any = {};
	public static pauseBattle = false;
	...
	//model----------
	/**选区*/public static modelPlayer: Model_player;
	/**创角*/public static modelLogin: ModelLogin;
	/**背包*/public static modelBag: Model_Bag;
	/**Gm*/public static modelGM: Model_GM;
	/**Gm*/public static modelMail: Model_Mail;
	/**Gm*/public static modelRL: Model_RongLian;
	/**玩家场景相关*/public static modelScene: ModelScene;
	/**技能*/public static modelSkill: Model_Skill;
	/**锻造*/public static modelDuanZao: Model_DuanZao;
	/**装备*/public static modelEquip: Model_Equip;
	/**神装*/public static modelGodEquip: Model_GodEquip;
	/**战甲*/public static modelZhanJia: Model_ZhanJia;
	/**图鉴*/public static modelTuJian: Model_TuJian;
	/** 全局消息 */public static modelGlobalMsg: Model_GlobalMsg;
	/**关卡*/public static modelGuanQia: ModelGuanQia;
	/**BOSS*/public static modelBoss: Model_Boss;
	/**官衔*/public static modelguanxian: Model_GuanXian;
	/**称号*/public static modeltitle: Model_Title;
	/**兽灵*/public static modelsl: Model_ShouLing;
	/**宝物*/public static modelbw: Model_BaoWu;
	/**星图*/public static modelxt: Model_XingTu;
	/**轮回*/public static modellh: Model_LunHui;
	/**神剑*/public static modelsj: Model_ShenJian;
	/**将魂*/public static modeljh: Model_JiangHun;
	/**武将*/public static modelWuJiang: Model_WuJiang;
	/**天书*/public static modeltianshu: Model_TianShu;
	/**兵法*/public static modelBingFa: Model_BingFa;
	/**商城*/public static modelshop: Model_Shop;
	/**异宝*/public static modelYiBao: Model_YiBao;
	/**设置*/public static modelSetting: Model_Setting;
	/**每日任务*/public static modeltask: Model_Task;
	/**一骑当千*/public static modelyjdq: Model_YJDQ;
	/**铜雀台*/public static modelPeacock: Model_Peacock;
	/**材料副本*/public static modelcailiao: Model_CaiLiao;
	/**国家*/public static modelCountry: Model_Country;
	/**国家*/public static modelCouSkill: Model_CountrySkill;
	/**国家王位之争*/public static modelKingship: Model_Kingship;
	/**排行榜*/public static modelRank: Model_Rank;
	/**南征北战*/public static modelnzbz: Model_NZBZ;
	/**过关斩将*/public static modelRunMan: Model_RunMan;
	/**三国战神*/public static modelsgzs: Model_SGZS;
	/**跨服*/public static modelWorldNet: Model_WorldNet;
	/**单刀赴会*/public static modelddfh: Model_DDFH;
	/**乱世枭雄*/public static modelCrossKing: Model_CrossKing;
	/**乱世枭雄*/public static modelCrossWars: Model_CrossWars;
	/**充值活动*/public static modelRecharge: Model_Recharge;
	/**充值*/public static modelchongzhi: ModelChongZhi;
	/**VIP*/public static modelvip: ModelVip;
	/**三国无双*/public static modelsgws: Model_SGWS;
	/**福利*/public static modelwelfare: Model_Welfare;
	/**七天登录*/public static modelsevent: Model_SevenDayLogin;
	/**晋升*/public static modeljinsheng: Model_JinSheng;
	/**功能预览*/public static modelPreview: Model_FunctionPreview;
	/**武圣榜*/public static modelWuSheng: Model_WuShengList;
	/**宝库*/public static modelBaoKu: Model_BaoKu;
	/**功能预览*/public static modelLingLong: Model_LingLong;
	/**聚宝盆*/public static modelJBP: ModelJBP;
	/**活动大厅*/public static modelActivityHall: Model_ActivityHall;
	/**聊天*/public static modelchat: Model_Chat;
	/**群英镑*/public static model_QunYingBang: Model_QunYingBang;
	/**开服狂欢*/public static model_KaiFKH: Model_KaiFKH;
	/**精彩活动*/public static modelHuoDong: Model_HuoDong;
	/**精彩活动8-14*/public static modelHuoD814: Model_HuoD814;
	/**专属活动*/public static modelHuoDOnly: Model_HuoDOnly;
	/**活动*/public static modelActivity: Model_Activity;
	/**超值返利*/public static modelCZFL: Model_ChaoZhiFL;
	/**全民狂欢*/public static modelqmkh: Model_QuanMinKH;
	/**分享 */public static modelShare: ModelShare;
	/**吕布降临 */public static modelLvBuCompup: ModelLvBuComeUp;
	/**血战到底 */public static modelWarToDead: ModelWarToDead;
	/**首冲团购 */public static modelGroupBuy: Model_GroupBuy;
	/**首冲团购 */public static modelGroupB814: Model_GroupB814;
	/**连续消费 */public static modelLXXF: ModelLXXF;
	/**连续消费814 */public static modelLXX814: ModelLXX814;
	/**国家boss */public static modelCtryBoss: ModelCtryBoss;
	/**组队副本 */public static modelCrossTeam: Model_CrossTeam;
	/**每日直购 */public static modelZhiGou: Model_ZhiGou;
	/**7系统优化 */public static modelBySys: Model_BySys;
	/**升阶秘境 */public static modelSJMJ: ModelShengJieMJ;
	/**烽火 */public static modelFengHuoLY: ModelFengHuoLY;
	/**7系统优化 */public static modelbwXianShi: Model_bwXianShi;
	/**战斗 */public static modelbattle: Model_battle;
	/**活动预览 */public static modelactPreView: ModelActPreView;
	/**三国庆典 */public static modelSGQD: ModelSGQD;
	/**闯关有礼 */public static modelChuangGuanYL: ModelChuangGuanYL;
	/**累充回馈 */public static modelLCHK: ModelLCHK;
	/**八门金锁 */public static modelEightLock: ModelEightLock;
	/**问鼎天下 */public static modelWenDingTX: ModelWenDingTX;
	/**八阵图 */public static modelBaZhenTu: Model_BaZhenTu;
	/**阵眼 */public static modelZhenYan: Model_ZhenYan;
	/**诸将演武 */public static modelZJYW: ModelZJYW;
	/**少主 */public static modelShaoZhu: Model_ShaoZhu;
	/**圣兽降临 活动 */public static modelActHolyB: Model_ActHolyBeast;
	/**实名认证 */public static modelTrueName: Model_TrueName;
	/**兽魂寻宝 */public static modelSHXunbao: Model_SHXunBao;
	/**BOSS战场 */public static modelBossZc: Model_BossZC;
	/**兽魂觉醒 */public static modelSHJX: ModelSH;
	/**觉醒 */public static modeljx: Model_JueXing;
	/**少主祈愿 */public static modelSZQiYuan: Model_SZQiYuan;
	/**三国一统 */public static modelSanGuoYT: Model_SanGuoYiTong;
	/**少主活动。 */public static modelShaoZhuAct: ModelShaoZhuAct;
	/**关卡协助。 */public static modelGuanQiaHelp: ModelGuanQiaHelp;
	/**跨服矿藏 */public static modelCrossMineral: Model_CrossMineral;
	/**专属神兵 */public static modelGodWeapon: Model_ZSGodWeapon;
	/**消费翻牌 */public static modelXFFP: ModelXFFP;
	/**消费摇骰 */public static modelXfyt: ModelXfyt;
	/**消费摇骰 */public static modelXyfq: ModelXyfq;
	/**打气球 */public static modelBalloon: ModelBalloon;
	/**限定武将 */public static modelXianding: ModelXianding;
	/**三国战令 */public static modelSGZL: ModelSGZL;
	/**三国战令（活动） */public static modelSGZL2: ModelSGZL2;
	/**宝藏拼图 */public static modelBzpt: ModelBzpt;
	/**宝藏拼图 */public static modelShop12: ModelShop12;
	/**群雄逐鹿 */public static modelQxzl: ModelQxzl;
	/**奇策 */public static modelQice: ModelQice;
	/**成就 */public static modelAchievement: ModelAchievement;
	/**跨服王者 */public static modelKfwz: ModelKfwz;
	/**幸运扭蛋 */public static modelLuckyEgg: ModelLuckyEgg;
	/**刮刮乐 */public static modelGGL: ModelGGL;
	/**成就树 */public static modelCJS: ModelCJS;
	/**火烧赤壁 */public static model_HSCB: Model_HSCB;
	/**少主护送 */public static modelShaoZhuEscort: Model_ShaoZhuEscort;
	/**六出祁山 */public static model_LiuChuQS: Model_LiuChuQS;
	/**轮回副本 */public static modelLhfb: ModelLhfb;
	/**三英战吕布 */public static model_Syzlb: Model_Syzlb;
	/**许天狩猎 */public static model_XuTian: Model_XuTian;
	/**异兽录 */public static modelYiShouLu: Model_YiShouLu;
	/**曹操来袭 */public static modelCaoCao: Model_CaoCaoCome;
	/**新活动 */public static model_actCom: Model_ActCom;
	/**新活动-vip折扣 */public static modelVipDiscount: Model_VipDiscount;
	/**新活动-三国宝藏 */public static modelsgbz: Model_CountryTreasure;
	/**新活动-充值排行 */public static modelczph: Model_ConsumeRankAct;
	/**仙山寻兽 */public static modelxsxs: Model_SearchAnimals;
	/**登陆有奖 */public static modelLoginGift: Model_LoginYouJiang;
	/**万兽之王 */public static modelWanShouZhiWang: Model_WanShouZhiWang;
	/**异兽送礼 */public static modelYSSL: ModelYSSL;
	/**虎牢关 */public static modelTigerPass: Model_TigerPass;
	/**修炼天赋 */public static modelTalent: Model_Talent;
	/**新活动-消费砸蛋 */public static modelxfzd: Model_ConsumeSmashEgg;
	/**活动-天赋 */public static modelActTalent: Model_ActTalent;
	/**异兽 bOSS */public static modelYiShouBOSS: ModelYiShouBOSS;
	/**合服活动-合服首充 */public static modelhfsc: Model_HFSC;
	/**合服活动-张飞醉酒 */public static modelzfzj: Model_ZFZJ;
	/**神将现世 */public static modelsjxs: Model_SJXS;
	/**神将 */public static modelGodWuJiang: ModelGodWuJiang;
	/**许愿树 */public static modelWishTree: Model_WishTree;
	/**神将 */public static modelLiangCao: ModelLiangCao;
	/**主题消费 */public static model_ZTXF: Model_ZTXL;
	/**桃园结义 */public static model_TYJY: Model_TYJY;
	/**主题消费 */public static model_LuckTurn: Model_LuckTurn;
	/**限时礼包 */public static model_limitGift: Model_LimitGift;
	/**全服消费 */public static model_ActQFXF: Model_ActQFXF;
	/**跨服试炼 */public static modelkfsl: Model_CrossShiLian;
	/**新活动-累计返利 */public static model_ActLJFL: Model_ActComLJFL;
	/**新活动-财神送礼 */public static modelCaiShenSongLli: Model_CaiShenSongLi;
	/**新活动-节日商店 */public static model_ActJRSC: Model_ActComJRSC;
	/**少主-六艺 */public static model_LiuYi: Model_LiuYi;
	/**镇守四方 */public static modelzssf: Model_ZSSF;
	/**少主-潜能 */public static model_QianNeng: Model_QianNeng;
	/**府邸-家丁 */public static modelHouseKeeper: Model_HouseKeeper;
	/**家园 */public static homemodel: HomeModel;
	/**宴会 */public static modelYanHui: Model_YanHui;
	/**少主-潜能 */public static model_Horse: Model_Horse;
	/**金鼠送财*/public static modelJSSC: Model_GoldenMouse;
	/**新活动-对对联 */public static model_DDL: Model_ActComDDL;
	/**新活动-天降红包 */public static model_TJHB: Model_ActComTJHB;
	/**官邸-侍女 */public static model_HomeMaid: Model_HomeMaid;
	/**官邸-任务 */public static model_HomeTask: Model_HomeTask;
	/**年兽 */public static model_ActNianShou: Model_ActNianShou;
	/**擂台 */public static model_ActLeiTai: Model_ActLeiTai;
	/**做元宵 */public static modelyuanxiao: Model_YuanXiaoLocal;
	/**红包系统 */public static modelHB: Model_HongBao;
	/**超级弹珠 */public static modelSuperMarbles: ModelSuperMarbles;
	/**攻城拔寨 */public static modelgcbz: Model_GCBZ;
	/**登峰造极 */public static modelDengFengZJ: Model_DengFengZJ;
	/**新活动-貔貅散宝 */public static model_ActPXSB: Model_ActComPXSB;
	/**武庙十哲 */public static model_ActWMSZ: Model_ActComWMSZ;
	/**犒赏三军 */public static modelWarOrder: Model_WarOrderAct;
	/**BT1 model */public static modelBT: ModelBT;
	//----------model
	...
	public static mainUICtr: MainUIController = new MainUIController();
	public static control: MsgCenter = new MsgCenter();
	public static mapscene: MapScene;
	public static resMgr: RESManager;
	public static socketMgr: WebSocketMgr;
	public static reddot: ReddotNoticeController;


	public static COMMON: string = "common";
	public static NUM: string = "num";//数字资源包名
	public static sceneType: number;
	public static sceneID: number = 0;
	public static packDic: { [pkgKey: string]: fairygui.UIPackage } = {};
	public static autoSkill: number = 0;
	public static createPack(key: string): fairygui.UIPackage {
		let t_pkg = GGlobal.packDic[key];
		if (!t_pkg)
			GGlobal.packDic[key] = t_pkg = fairygui.UIPackage.addPackage(key);
		return t_pkg;
	}

	public static setUnitLayerVis(v, n = true) {
		if (GGlobal.mapscene) {//不能在layermanager处理
		...
		if (forceShow) ViewMainTopUI.instance.visible = true;
	}

	static deCodeLogin(data) {
		const self = GGlobal;
		self.loginArg = data;
		...
		Model_UserData.isWhitePlayer =  (window as any).whitelist;
	}

	static requestLoginData_ADB(data) {
		const self = GGlobal;
		self.loginArg = data;
		self.zone = data.zoneid ? Number(data.zoneid) : 1;
		self.ip = data.ip ? data.ip : "192.1.1.1";
