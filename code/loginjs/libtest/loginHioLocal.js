...
function showfenhaoAlert() {
    ...
    $('#popbg').show();
    $('#popbg').click(function (e) { reLoginWeb(); });
}
...
function createfenhaoAlert() {
    ...
    $('#server').prepend(str);
    $('#fenhaoalert').click(function (e) { hidefenhaoAlert(); reLoginWeb(); });
}
...
function createAlert() {
    ...
    $('#server').append(str);
    $('#alert').click(function (e) { $("#server").unbind("click"); hideAlert(); });
}
//服务器列表
...
function bodyOnLoad() {
    ...
    // if (!isDebugModel && loginArg && loginArg.clientversion) {
    //     mainurl = './manifest' + loginArg.clientversion + '.json?v=' + Math.random();
    //     console.log(mainurl);
    // }
