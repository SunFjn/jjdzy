...
$(document).ready(function (e) {
  $('.goplay').click(function () {
    ...
    if (isDebugModel) loginArg.account = $("#zhanghaoTxt.newInput").val();
...
function getPlatformType() {
  ...
  if (loginArg.platform.indexOf("cdsb-") >= 0) {
    //赛博
    return 1;
  }

  if (loginArg.platform.indexOf("shxy-") >= 0) {
    //深海
    return 2;
  }

  if (loginArg.platform.indexOf("sqxy-") >= 0) {
    //手趣
    return 3;
  }
