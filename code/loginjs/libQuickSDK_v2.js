...
function doInit(params,callback){
	...
	$.ajax({
		type:"GET",
		url:'http://qkh5api.quickapi.net/webGame/initApi?' + 33827237067467388509055845353587,
		dataType:"json",
		success:function(data){
			//load channel lib
			loadChannelLib(data,function(){
				channelParams = data.channelClientParams; // add by andyhua
				callChannelInit(33827237067467388509055845353587 + '&quick_channel_data=' + JSON.stringify(data.channelData) + '&quick_channel_token=' + data.channelToken);
				callback();
